...
# Inserting a row of static data with id as 1, username as naresh
...
# defining function called dynamic_user_entry for generating username and password as per the task
...
for i in range(2,6):# calling dynamic_user_generate to generate random username and password
